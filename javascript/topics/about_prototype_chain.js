...
test("Is there an 'a' and 'b' property on child?", function () {
  equal(__, child.a, getString("ABOU_WHATISA_1"));
  equal(__, child.b, getString("ABOU_WHATISB_2"));
});
...
test(getString("ABOU_ISTHERE_3"), function () {
...
test(getString("ABOU_ISTHERE_4"), function () {
